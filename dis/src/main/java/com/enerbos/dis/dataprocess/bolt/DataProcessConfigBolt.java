...
public class DataProcessConfigBolt implements IRichBolt {
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declareStream("data-process-config", new Fields("tagid","data","type"));
    }
    ...
    private boolean updateAcqConfig(List cfgs){
        ...
        while(itorDataProcessRule.hasNext()){
            ...
            collector.emit("data-process-config",new Values(entry.getKey(),entry.getValue(),DisMessage.MS_ACQCFGCMD));
        }
