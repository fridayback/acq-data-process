...
/*
 * HisDataSpout.java
 * Created on  2018/3/18 9:57
 * 版本       修改时间          作者      修改内容
 *            2018/3/18      liulin    初始版本
 */
package com.enerbos.dis.dataprocess.spout;/*
 * HisDataSpout
 * Created on  202018/3/18 9:57  by liulin
 *  ${COPYRIGHT}
 */
...
public class HisDataSpout implements IRichSpout{
    private SpoutOutputCollector collector;
    private  KafkaConsumer<String, String> consumer;
    private Logger log = LoggerFactory.getLogger(HisDataSpout.class);
    ...
    public void nextTuple() {
        ...
        if(debugFlag){
            ...
            try {
                ...
                if(disMessage.getType().equals(DisMessage.MS_HISDATA)){
...
//                            }
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        String topicstr = conf.get("his-data-topic").toString();
        String groupId = conf.get("his-data-groupid").toString();
